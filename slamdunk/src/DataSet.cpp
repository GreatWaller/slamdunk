...
namespace slamdunk {
    ...
    bool Dataset::Init() {
        ...
        if (!fin) {
            ...
            LOG_CORE_ERROR("cannot find {0}/calib.txt!", dataset_path_);
            return false;
        }
        ...
        for (int i = 0; i < 4; ++i) {
            ...
            LOG_CORE_INFO("Camera {0} extrinsics: {1}", i, t.transpose());
        }
        fin.close();
    ...
    Frame::Ptr Dataset::NextFrame() {
        ...
        std::string fmt("{:s}/image_{:d}/{:06d}.png");
        ...
        if (image_left.data == nullptr || image_right.data == nullptr) {
            ...
            LOG_CORE_WARN("cannot find images at index {0}", current_image_index_);
            return nullptr;
        }
